...
sudo_users = {SUDO,1664925377,1590091397,}   
...
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(1664925377) then
var = 'مبرمج النهاية'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."DEV:Sudo:T", user_id) then 
...
send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث السورس \n ❃∫ لديك اخر اصدار لسورس النهاية\n ❃∫ الاصدار » { 1.3v}')
dofile('BOYKA.lua')  
end
if text == 'الاصدار ❃' and DevBOYKAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ اصدار سورس النهاية \n ❃∫ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ❃' and DevBOYKAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ [تحديثات البوت](t.me/th3_3nd) \n ❃∫ [قناه السورس](t.me/pvv_v)')
end
...
send(msg.chat_id_, msg.id_, "حمسح صوره قبل ماسرقها😂🥺 ")
...
local Text = {
  "لو غيرت الصوره تني هزعلك",
  "متيجي يقمر الصوره دي احلا",
  "كل شويه تغير صوره😍😂",
  "الصوره الجديده عظمه 😹😹🌚",
  "صورتك القديمه قامده ؟😹🌞",
  "غيرت صورتك لي هه ؟؟ 🤔🌞",
...
Text = [[
≪━━━━━━𝙳𝙴𝙱𝙾 ♫ ━━━━━━≫
 ❃∫ ↬[Information](t.me/th3_3nd)
≪━━━━━━𝙳𝙴𝙱𝙾 ♫ ━━━━━━≫
 ❃∫ ↬[DEVELOPER](t.me/UU_IIVV)
≪━━━━━━𝙳𝙴𝙱𝙾 ♫ ━━━━━━≫
 ❃∫ ↬[To talk to us](t.me/the_eennd_bot)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
send(msg.chat_id_, msg.id_," ❃∫ عذرا الملف لايدعم سورس النهاية \n") 
end
return false
end
...
-----------------------------------------------------
if text == 'تنزيل العرصات' and Mod(msg) then
database:del(bot_id..'Mode:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ❃∫ تم مسح جميع المطايه')
end
if text == ("تاك للعرصات") and Mod(msg) then
local list = database:smembers(bot_id..'Mode:User'..msg.chat_id_)
t = "\n ❃∫ قائمه عرصات الجروب \n≪━━━━━━𝙳𝙴𝙱𝙾 ♫ ━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» العرصه [@"..username.."]\n"
else
t = t..""..k.."» العرصه `"..v.."`\n"
end
end
if #list == 0 then
t = " ❃∫ مع الاسف لا يوجد عرصه"
end
send(msg.chat_id_, msg.id_, t)
end
---------
if text == ("رفع العرصه") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local  statuss  = '\n ❃∫ تم رفع العضــو العرصه في الجروب \n ❃∫ تعال يعرصه ممكن نتعرف'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if (text == ("تنزيل العرصه")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
status  = '\n ❃∫ تم تنزيل العضــو العرصه من الجروب\n ❃∫ مشيي مو خوش عرصهه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if text == ("تاك للعرص") and Mod(msg) then
local list = database:smembers(bot_id..'Modde:User'..msg.chat_id_)
t = "\n ❃∫ قائمه عرص الجروب \nٴ≪━━━━━━𝙳𝙴𝙱𝙾 ♫ ━━━━━━≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» العرص [@"..username.."]\n"
else
t = t..""..k.."» العرص `"..v.."`\n"
end
end
if #list == 0 then
t = " ❃∫ مع الاسف لا يوجد عرص"
end
send(msg.chat_id_, msg.id_, t)
end
---------
if text == ("رفع العرص") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n ❃∫ تم رفع العضــو العرص في الجروب \n ❃∫ تعال حبي العرص نطيني بوسه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if (text == ("تنزيل العرص")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'pvv_v')..')'
status  = '\n ❃∫ تم تنزيل العضــو العرص من الجروب\n ❃∫ مشيي مو خوش عرص'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ❃∫ تم تنزيل جميع شراميط من الجروب')
end
...
---------
if text == ("رفع شرموط") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'pvv_v')..')'
local  statuss  = '\n ❃∫ تم رفع المتهم شرموط بالجروب\n ❃∫ الان اصبح شرموط الجروب'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if (text == ("تنزيل شرموط")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'النهاية').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'النهاية')
local BOYKA_Msg = {
'عايز اي 🥺💕.',
'اي يرخم ☹️.',
'مفيش غيري هنا يعني 😂.',
'مش فاضي ؟ اسمي '..Namebot..'',
'مشغول حالياً',
'معاك يرحي '..Namebot..' كول حب'
}
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'النهاية').." غادر" or text == 'غادر' then  
...
*❃🍺م7 ◂ اوامر التحشيش*
*❃🍁م8 ◂ اوامر مطور البوت*
*❃م⚡9 ◂ اوامر مطور الاساسي* 
*❃💫م10 ◂ اوامر الاعضاء*
ٴ≪━━━━━━𝙳𝙴𝙱𝙾 ♫ ━━━━━━≫ٴ
彡 .[the end ••••](t.me/th3_3nd)➢ 
]]
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"بس يكلب يبنلكب 👞👈","خساره فيك الشخره","نت طيز 🤣"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "مصه" or text == "بوسه" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"مووووووووواححح????","مش هبوس ولد😌😹","خدك/ نضيف 😂","البوسه جامدهه 🌝💋","خلي يجيب نوتيلا وابوسه 🙊😻","كل شويه ابوسه كافيه 😏","م هبوسه والله لانه معفن🦎","محح دي ليكي يمظه??"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'النهاية')
